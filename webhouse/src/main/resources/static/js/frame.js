...
(function () {
    ...
    var data = [
        ...
        },
        {
            ...
            level:1,
            children:[
                {id:'012',level:2,icon:'',title:'地区管理',path:'city.html',children:[]},
                {id:'013',level:2,icon:'',title:'房源管理',path:'house.html',children:[]},
                {id:'013',level:2,icon:'',title:'岗位管理',path:'salesList.html',children:[]},
                {id:'014',level:2,icon:'',title:'类型管理',path:'typeList.html',children:[]},
                {id:'015',level:2,icon:'',title:'标签管理',path:'tagList.html',children:[]}
            ]
        },
        {
            id:'016',
